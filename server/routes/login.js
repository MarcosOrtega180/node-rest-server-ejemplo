...
app.post('/google', async (req, res) => {
    ...
    Usuario.findOne({email: googleUser.email}, (err, usuarioDB) => {
        ...
        //si es que el usuario ya exíste en la base de datos
        if (usuarioDB) {
            ...
            if (usuarioDB.google === false) {
                ...
                //renovamos su token en caso que ya exista en la base de datos y se haya logueado por google
                let token = jwt.sign({usuario: usuarioDB}, process.env.SEED, {expiresIn: process.env.expiresIn});
                return res.json({
                    ok: true,
                    usuario: usuarioDB,
            ...
            // Si el usuario no existe en la base de datos hay que cargarlo
